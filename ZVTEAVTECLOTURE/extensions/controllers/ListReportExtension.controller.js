sap.ui.controller("reporting_vte_avte_cloture.extensions.controllers.ListReportExtension", {

 onAfterRendering: function () {
      //Id trouvé dans le changes.changes-bundle sinon chercher à l'aide de l'onglet Elements du debugger.
      var oSmartTable = this.byId("reporting_vte_avte_cloture::sap.suite.ui.generic.template.ListReport.view.ListReport::ZC_VteAVteCloture--listReport");
