sap.ui.controller("reporting_vte_aprvte_agence_depositaire.extensions.controllers.ListReportExtension", {


  onAfterRendering: function () {
      //Id trouvé dans le changes.changes-bundle sinon chercher à l'aide de l'onglet Elements du debugger.
      var oSmartTable = this.byId("reporting_vte_aprvte_agence_depositaire::sap.suite.ui.generic.template.ListReport.view.ListReport::ZC_AgencesEtDepositairesI--listReport");
