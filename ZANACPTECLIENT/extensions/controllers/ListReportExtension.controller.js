sap.ui.controller("reporting_compte_client.extensions.controllers.ListReportExtension", {


  onAfterRendering: function () {
      //Id trouvé dans le changes.changes-bundle sinon chercher à l'aide de l'onglet Elements du debugger.
      var oSmartTable = this.byId("reporting_compte_client::sap.suite.ui.generic.template.ListReport.view.ListReport::ZC_AnaCpteClient--listReport");
